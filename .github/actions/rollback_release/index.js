...
async function rollbackRelease() {
  ...
  publish_id = workflows.data.workflows.find(x => x.name === 'Publish Docsite').id
  ...
  await octokit.request(`POST /repos/Bandwidth/api-docs/actions/workflows/${publish_id}/dispatches`, {
    ref: goodRelease,
  })
}
