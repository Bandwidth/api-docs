                ...
                },
                {
                    ...
                    items: [
                        "numbers/searchingAndOrderingNumbers",
                        {
                            ...
                            items: [
                                "numbers/porting/portingNumbersOverview",
                                "numbers/porting/orderModel",
                                {
                                    type: "category",
                                    label: "Port-ins",
                                    items: [
                                        "numbers/porting/portinOverview",
                                        {
                                            type: "category",
                                            label: "Stand-Alone Port-ins",
                                            items: [
                                                "numbers/porting/standAlonePortinsOverview",
                                                "numbers/porting/lnpChecker",
                                                "numbers/porting/tollFreePortingValidations",
                                            ],
                                        },
                                        "numbers/porting/bulkPortins",
                                        "numbers/porting/csrRequests",
                                    ],
                                },
                                {
                                    type: "category",
                                    label: "Port-outs",
                                    items: [
                                        "numbers/porting/portOutOverview",
                                        "numbers/porting/lsrOrders",
                                        "numbers/porting/portOutNotifications",
                                    ],
                                },
                                "numbers/porting/terminology",
                            ],
                        },
