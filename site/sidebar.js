  ...
  mySidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        // "numbers/numbersApiV2",
        {
          type: "category",
          label: "Porting",
          items: [
            "numbers/porting/about",
            ...
            "numbers/porting/terminology",
            {
              ...
              label: "Port-Ins",
              items: [
                "numbers/porting/port-ins/about",
                {
                  type: "category",
                  label: "Stand-Alone Port-Ins",
                  items: [
                    "numbers/porting/port-ins/stand-alone-port-ins/about",
                    "numbers/porting/port-ins/stand-alone-port-ins/lnpChecker",
                    "numbers/porting/port-ins/stand-alone-port-ins/tollFreePortabilityValidations",
                  ],
                },
                "numbers/porting/port-ins/bulkPortIns",
                "numbers/porting/port-ins/csrs",
              ],
            },
            {
              type: "category",
              label: "Port-Outs",
              items: [
                "numbers/porting/port-outs/about",
                "numbers/porting/port-outs/lsrs",
                "numbers/porting/port-outs/portOutNotifications",
              ],
            },
          ],
        },
