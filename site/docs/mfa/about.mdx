...
To create an MFA event - simply send a <Highlight color="#079CEE">POST</Highlight> request to the MFA API and Bandwidth will handle creating the message/phone call event, and when your end user inputs the code into your service to verify, send that in a <Highlight color="#079CEE">POST</Highlight> request to Bandwidth and we will return wheteher or not the code is valid.
