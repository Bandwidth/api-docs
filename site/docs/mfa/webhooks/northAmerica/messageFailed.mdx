---
id: messageFailedNorthAmericaMfaWebhooks
title: Message Failed Webhooks - North America
slug: /mfa/webhooks/north-america/message-failed
description: About Bandwidth's MFA North America Message Failed Webhooks
keywords:
  - mfa
  - callbacks
  - webhooks
...
custom_edit_url: github.com/Bandwidth/api-docs/tree/main/site/docs/mfa/webhooks/northAmerica/messageFailed.mdx
---
...
|:----------------------|:---------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| type                  | `string` | The Webhook (Callback) type. For message failed, this is set to `message-failed`.                                                                                                                                                                                                                                                                                                                                                    |
...
| errorCode             | `integer`| The error code associated with the failure. See list of error codes [here](/docs/messaging/errors#messaging-errors/).                                                                                                                                                                                                                                                                                                        |
