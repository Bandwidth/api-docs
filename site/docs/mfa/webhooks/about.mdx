...
- The type of North America webhooks are as follows:
  - [message-delivered](/docs/mfa/webhooks/north-america/message-delivered/) - Message has been delivered to the carrier.
  - [message-failed](/docs/mfa/webhooks/north-america/message-failed/) - Message failed to deliver.
...
- The type of international webhooks are as follows:
  - [message-delivered](/docs/mfa/webhooks/international/message-delivered/) - Message has been delivered to the carrier.
  - [message-failed](/docs/mfa/webhooks/international/message-failed/) - Message failed to deliver.
