---
id: mediaAndTTSGuide
title: Media and Text-To-Speech Guide
slug: /voice/guides/mediaAndTTSGuide
...
In this guide we will show you how to play media and use text to speech for calls. Please ensure you have followed our earlier guide on [how to make an outbound call](/docs/voice/guides/outboundCallGuide) with Bandwidth.
...
- [How to record calls & transcribe](/docs/voice/guides/recordingGuide)
- [How to gather user input (IVR)](/docs/voice/guides/interactiveVoiceResponseGuide)
- [How to use voicemail detection](/docs/voice/guides/machineDetectionGuide)
