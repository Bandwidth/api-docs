...
You can port your numbers from Twilio to Bandwidth without devoting any downtime by following a few simple steps in our [Porting Numbers](/docs/numbers/porting/port-ins/) guide.
