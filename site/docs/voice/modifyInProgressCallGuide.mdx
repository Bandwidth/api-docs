...
title: Modify call guide
slug: /voice/guides/modifyInProgressCallGuide.mdx
...
In this guide we will show you how to modify the BXML for a call already in progress. Please ensure you have followed our earlier guide on [how to make an outbound call](/docs/voice/guides/outboundCallGuide) with Bandwidth. It is recommended to use a request manager like POSTMAN for this tutorial, but the SDKs are also capable.
