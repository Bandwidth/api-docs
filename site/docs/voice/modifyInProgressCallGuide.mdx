...
Next, send a `POST` request to [`https://voice.bandwidth.com/api/v60/accounts/{your_account_id}/calls/{the_call_id}`](/apis/voice/#operation/modifyCall)
...
body.redirect_url = {YOUR_REDIRECT_URL}
body.state = "active"
#remember to add auth for your application if needed!
...
$body->redirectUrl = {YOUR_REDIRECT_URL};
$body->state = "active";
#remember to add auth for your application if needed!
