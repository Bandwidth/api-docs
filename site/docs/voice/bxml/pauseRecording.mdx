...
Audio that occurs between a `<PauseRecording>` verb and a [`<ResumeRecording>`](/docs/voice/bxml/resumeRecording.md) verb will not be present in the recording.
...
### PauseRecording on Transfered Calls
