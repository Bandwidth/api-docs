...
- The user presses any of the terminating digits (if specified)
...
In this example, there is one SpeakSentence and two PlayAudios nested within the gather. If, after playing, the caller doesn't press a button, the audio will replay two more times.
