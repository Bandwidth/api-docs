...
The Bandwidth Voice API will report call errors via [Webhooks](/docs/voice/webhooks) to the call status URL defined in your voice application.

Errors can also be found for a specific call by [querying the call](/voice-api-reference#operation/getCall).
