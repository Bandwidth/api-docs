...
machine_detection_parameters.detection_timeout = 6.2
machine_detection_parameters.silence_timeout = 4.3
machine_detection_parameters.speech_threshold = 8.0
machine_detection_parameters.speech_end_threshold = 2.1
