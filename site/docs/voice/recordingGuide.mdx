...
If you want to be alerted of your transcription being ready, you can use the transcriptionAvailableUrl to send an event to the specified endpoint. Note that a JSON will be sent in the response body with all pertinent information for the transcription.
