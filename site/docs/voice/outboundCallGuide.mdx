...
title: Outbound Call Guide
slug: /voice/guides/outboundCallGuide
...
### Where to next?
- [How to play media and perform text to speech](/docs/voice/guides/mediaAndTTSGuide)
...
- [How to retrieve call logs](/docs/voice/guides/callInformationGuide)
