...
To create an outbound call from a Bandwidth number, you must make a POST request to our API v2 /calls endpoint. This can be done through our SDKs, using tools like [Postman](https://www.postman.com/), or in command line.
