...
To show how this works, first place a call.
...
<TabItem value="payload">
    ...
    We recommend using Postman to send requests.
...
Then pipe the callId to make another request to retrieve the call's information. Note that you will still need your basic account details; i.e. your account ID and basic auth creds.
