...
If you are a legacy WebRTC customer, the prior Versions of the Bandwidth Developer documenation can be found [here]().  These prior [API Documentation Versions](/docs/versions) contain the documentation presented just as you are used to.
