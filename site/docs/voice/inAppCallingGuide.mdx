...
# Migration for Legacy WebRTC Users

If you are a user of the Bandwidth AUdio/Video WebRTC solution, you may be a candidate for migration to the In-App Calling solution, and may be the beneficiary of the simpler, and in some ways more powerful approach to voice calling over WebRTC.

The migration from the existing services to the new In-App calling is described in a [Migration Guide](/docs/voice/inAppCallingMigrationGuide) document.

If you are a legacy WebRTC customer, the prior Versions of the Bandwidth Developer documenation can be found [here](/docs/versions).  These prior [API Documentation Versions](/docs/versions) contain the documentation presented just as you are used to.
