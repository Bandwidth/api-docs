...
import DocsDiagram from '@site/src/components/DocsDiagram.js';
import VoiceSvg from '@site/static/img/product-icons/voice.svg';
import DesktopDiagram from '@site/static/img/docs-diagrams/voice/about-desktop.svg';
import MobileDiagram from '@site/static/img/docs-diagrams/voice/about-mobile.svg';
...
export const diagram = {
  description: 
    <ol>
      <li>Initiate the call by using our REST API</li>
      <li>Bandwidth makes a HTTP GET or POST request to your application</li>
      <li>Use BXML verbs to leverage Voice API features for the call</li>
    </ol>,
