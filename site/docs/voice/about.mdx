...
Use our [SpeakSentence](/docs/voice/bxml/speakSentence) verb to convert typed words to speech, powered by Amazon Polly. Seventeen voices, twenty-six languages. Use [SSML](https://www.w3.org/TR/2010/REC-speech-synthesis11-20100907/) to customize your audio to include pauses, emphasis, and much more.

### Recording

With the [Record](/docs/voice/bxml/record) verb, customers can save calls to play back later.
...
The [Conference](/docs/voice/bxml/conference) BXML Verb allows customers to create conference calls, including a [coach](/docs/voice/bxml/conference#join-a-conference-as-a-coach) function to have a user only heard by select attendees of the conference.

### Answering Machine Detection

[Answering Machine Detection](/docs/voice/guides/machineDetection) allows customers to distinguish whether a human or machine is speaking on a call.

### Caller Name Service (CNAM)

Bandwidth's [Caller Name service](/docs/voice/guides/cnamPerDip) provides the business name on VoIP calls in the US and Canada using our CNAM database. This feature must be enabled.
