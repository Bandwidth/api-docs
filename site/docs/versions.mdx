...
**TODO: Convert this to a react component for better reusability**

This table contains all of our current LTS versions of the doc site, which are snapshots of the site and its contents taken every two weeks on Tuesdays.
...
|   Version   |    Release Date    |  Sunset Date   |             Hosted Link              | Github Release |
|:-----------:|:------------------:|:--------------:|:-------------------------------------|:---------------|
| v2022.09.23 | September 23, 2022 | March 23, 2022 | [Current](https://dev.bandwidth.com) | [v2022.09.23](https://github.com/Bandwidth/api-docs/releases/tag/v2022.09.23)
...
Even though we only release an LTS version of the site every two weeks, we release changes to the site almost daily.
...
2. **Download and Extract the Release.**
    * In the `Assests` section on the release page, there will be links to both a `.zip`, and `tag.gz` file that contain the contents of that release.
