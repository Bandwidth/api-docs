...
id: setup
title: Setup
slug: /account/guides/setup
description: How to set up your Bandwidth Dashboard account
keywords:
  - bandwidth
  - account
  - setup
...
This walks through how to setup and configure your Bandwidth account through the [Bandwidth Dashboard](dashboard.bandwidth.com) for use with our [Number Management](../../numbers), [HTTP Voice](../../voice), and [HTTP Messaging](../../messaging) API's.

Now that we’ve covered the [hierarchical structure](./account/guides/structure.md) of your Bandwidth Dashboard account, let’s talk about how to complete your set-up.
...
Create an [API-only user](./account/guides/credentials.md) to validate your API calls. Unlike user accounts that can access the Bandwidth Dashboard User Interface, users restricted to API only access won’t require periodic password resets.
