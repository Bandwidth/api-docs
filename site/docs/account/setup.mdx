...
This walks through how to setup and configure your Bandwidth account through the [Bandwidth Dashboard](https://www.dashboard.bandwidth.com) for use with our [Number Management](../numbers), [HTTP Voice](../voice), and [HTTP Messaging](../messaging) APIs.
