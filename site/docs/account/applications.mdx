...
The remainder of this guide covers how to create applications via the API. For a detailed guide using the UI, please see our [account setup guide](/docs/account/setup).
