...
<img
  src={require('@site/static/img/docs-diagrams/account/setup-1.png').default}
  alt="Account Setup 1"
  class="center"
/>
...
### Sub-Account Fields
<img
  src={require('@site/static/img/docs-diagrams/account/setup-subaccount-fields.png').default}
...
<img
  src={require('@site/static/img/docs-diagrams/account/setup-2.png').default}
  alt="Account Setup 2"
  class="center"
/>
...
<img
  src={require('@site/static/img/docs-diagrams/account/setup-voice-application-fields.png').default}
...
<img
  src={require('@site/static/img/docs-diagrams/account/setup-messaging-application-fields.png').default}
...
<img
  src={require('@site/static/img/docs-diagrams/account/setup-3.png').default}
  alt="Account Setup 3"
  class="center"
/>
...
### Location Fields
<img
  src={require('@site/static/img/docs-diagrams/account/setup-location-fields.png').default}
  alt="Location Fields"
  class="center"
/>
<br/>
...
<img
  src={require('@site/static/img/docs-diagrams/account/setup-4.png').default}
  alt="Account Setup 4"
  class="center"
/>
