...
<img
  src={require('@site/static/img/docs-diagrams/account/sip-credentials.png').default}
  alt="Sip Credentials"
/>
...
<img
  src={require('@site/static/img/docs-diagrams/account/create-realm.png').default}
...
<img
  src={require('@site/static/img/docs-diagrams/account/add-sip-cred-button.png').default}
...
<img
  src={require('@site/static/img/docs-diagrams/account/create-sip-credentials.png').default}
...
<img
  src={require('@site/static/img/docs-diagrams/account/sip-registrar-realms.png').default}
