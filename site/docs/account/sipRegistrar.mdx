...
<img
  src={require('../../static/img/sip-credentials.png').default}
  alt="Sip Credentials"
/>
...
<img
  src={require('../../static/img/create-realm.png').default}
...
<img
  src={require('../../static/img/add-sip-cred-button.png').default}
...
<img
  src={require('../../static/img/create-sip-credentials.png').default}
...
<img
  src={require('../../static/img/sip-registrar-realms.png').default}
