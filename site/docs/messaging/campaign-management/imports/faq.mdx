...
You can share your campaigns with Bandwidth DCA in the TCR UI or by making a request to PUT csp-api.campaignregistry.com/campaign/{campaignId}/sharing/BANDW - For more info, please see the [TCR CSP API Documentation](https://csp-api.campaignregistry.com/v2/restAPI#/Campaign/shareCampaign)
