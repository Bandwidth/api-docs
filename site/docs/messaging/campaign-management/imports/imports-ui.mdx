...
<img
  src={require('@site/static/img/docs-diagrams/messaging/campaign-import-list.png').default}
/>
...
<img
  src={require('@site/static/img/docs-diagrams/messaging/campaign-import-modal.png').default}
/>
<br/>
...
<img
  src={require('@site/static/img/docs-diagrams/messaging/tn-option-order-1.png').default}
/>
<br/>
...
<img
  src={require('@site/static/img/docs-diagrams/messaging/tn-option-order-2.png').default}
/>
<br/> 
  
<img
  src={require('@site/static/img/docs-diagrams/messaging/tn-option-order-3.png').default}
/>
<br/>
...
<img
  src={require('@site/static/img/docs-diagrams/messaging/disabled-location-defaults.png').default}
/>
<br/>
...
<img
  src={require('@site/static/img/docs-diagrams/messaging/tn-bulk-upload-1.png').default}
/>
<br/>
...
<img
  src={require('@site/static/img/docs-diagrams/messaging/tn-bulk-upload-2.png').default}
/>
<br/>
