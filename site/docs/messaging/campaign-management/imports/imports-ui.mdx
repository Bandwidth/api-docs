...
* You have shared your provisioned campaigns with [Bandwidth DCA](/docs/messaging/campaign-management/imports/faq/)
...
For a full list of status values and descriptions, please see [our campaign FAQs](/docs/messaging/campaign-management/imports/faq/) <br/>
...
After you've finished importing your campaigns, explore our inventory and order a phone number to your account. Once you have a phone number, you are ready to [send your first text message](/docs/messaging/createMessage/). For help, check out our [SDK’s and Postman Collection](/sdks/).
