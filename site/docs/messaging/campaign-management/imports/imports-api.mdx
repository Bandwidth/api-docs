...
This walks through how to programmatically import and view your campaigns _via APIs_ for use with our [Number Management](/docs/numbers/) and [Messaging](/docs/messaging/) API's.
...
We do not have a publicly exposed REST endpoint for bulk TN updates. Please see how to import a csv in our [campaign import Dashboard UI guide](/docs/messaging/campaign-management/imports/imports-ui/).<br/>
For more info on TNs, please see [Number Management](/docs/numbers/).<br/>
