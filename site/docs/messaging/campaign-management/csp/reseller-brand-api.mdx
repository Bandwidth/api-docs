...
title: Bandwidth 10DLC Reseller And Brand CSP API Guide
sidebar_label: Reseller and Brand API Guide
...
The [10dlc](../about) resource is authenticated with your [API Credentials for "Number & Account Management"](../../../account/credentials)
...
The [brands](../about) resource is authenticated with your [API Credentials for "Number & Account Management"](../../../account/credentials)
