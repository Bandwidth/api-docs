...
| 4772 | rejected-tn-blocked | Blocked sender or receiver | This error indicates a blocked Sender or Receiver on the downstream platform. Bandwidth will need to open a ticket with our vendor to determine which telephone number is blocked and why. | YES |
