...
<Highlight color="#00bf8c">GET</Highlight> <a href="/messaging-api-reference#operation/ListMedia"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media</code></a>
...
<Highlight color="#00bf8c">GET</Highlight>  <a href="/messaging-api-reference#operation/GetMedia"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media/{mediaId}</code></a>
...
<Highlight color="#652B51">PUT</Highlight>  <a href="/messaging-api-reference#operation/UploadMedia"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media/{mediaId}</code></a>
...
<Highlight color="#ff6f47">DELETE</Highlight>  <a href="/messaging-api-reference#operation/DeleteMedia"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media/{mediaId}</code></a>
