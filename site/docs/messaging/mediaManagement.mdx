...
<Highlight color="#00bf8c">GET</Highlight> [<code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media</code>](/messaging-api-reference#operation/ListMedia)
...
<Highlight color="#00bf8c">GET</Highlight> [<code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media/{mediaId}</code>](/messaging-api-reference#operation/GetMedia)
...
<Highlight color="#652B51">PUT</Highlight> [<code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media/{mediaId}</code>](/messaging-api-reference#operation/UploadMedia)
...
<Highlight color="#ff6f47">DELETE</Highlight> [<code>https://messaging.bandwidth.com/api/v2/users/{accountId}/media/{mediaId}</code>](/messaging-api-reference#operation/DeleteMedia)
