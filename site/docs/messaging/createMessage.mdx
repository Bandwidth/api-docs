...
<Highlight color="#079CEE">POST</Highlight> <a href="/apis/messaging#operation/CreateMessage"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/messages</code></a>
