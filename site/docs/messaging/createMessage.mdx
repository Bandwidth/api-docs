...
<Highlight color="#079CEE">POST</Highlight> <a href="/messaging-api-reference#operation/CreateMessage"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/messages</code></a>
