...
:::note
Bandwidth does not store text message content, the content in the `text` field. After sending the API request it is inaccessible and will not be returned in subsequent status callbacks or GET requests. If you need this information, it is recommended that you log/store it in your application.
:::
