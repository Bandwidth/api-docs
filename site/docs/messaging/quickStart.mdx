...
## In This Guide
* [Configuring Callback URLs](#configuring-callback-urls)
    * [Creating a Personal Server](#creating-a-personal-server)
    * [Using Pipedream](#using-pipedream)
* [Sending a Message](#sending-a-message)
    * [Sent Message Callbacks](#sent-message-callbacks)
...
the latter is not reccomended, especially for use cases that are more complex.
