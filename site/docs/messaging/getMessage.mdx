...
<Highlight color="#00bf8c">GET</Highlight> <a href="/apis/messaging#operation/GetMessages"><code>https://messaging.bandwidth.com/api/v2/users/{accountId}/messages</code></a>
