...
To check if your numbers can be imported for hosted messaging, make a <Highlight color="#079CEE">POST</Highlight> request to our [Import TN Checker API](/apis/numbers/#tag/Import-Hosted-Messaging-Tn/operation/CreateImportTnOrder/) endpoint.
...
make a <Highlight color="#079CEE">POST</Highlight> request to our [Create Import TN Order API](/apis/numbers/#tag/Import-Hosted-Messaging-Tn/operation/CreateImportTnOrder/) endpoint.
This can be done through tools like [Postman](https://github.com/Bandwidth/postman) or cURL.
...
Otherwise, you can make a <Highlight color="#00bf8c">GET</Highlight> request to [Fetch Import TN Order status API](/apis/numbers/#tag/Import-Hosted-Messaging-Tn/operation/ReadImportTnOrder/) endpoint to poll the order status.
...
To upload a LOA file, make a <Highlight color="#079CEE">POST</Highlight> request to [Import TN Order LOAs API](/apis/numbers/#tag/Import-Hosted-Messaging-Tn/operation/CreateImportTnOrderLoas/) endpoint.
This can be done through tools like [Postman](https://github.com/Bandwidth/postman) or cURL.
