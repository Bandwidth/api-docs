...
To show general number information, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Information API](/apis/numbers/#tag/Tns/operation/RetrieveTnReservetionInfoForThatTn) endpoint.
