...
| npaNxx                  | The first 6 digits of the phone number starting with area code, ie. the area code (NPA - Number Plan Area) and prefix (NXX - Exchange or Central Office Code).                                               | 123456            |
| npaNxxx                 | The first 7 digits of the phone number starting with area code, ie. the area code (NPA - Number Plan Area), prefix (NXX - Exchange or Central Office Code), and 1 additional digit following the prefix.     | 1234567           |
