---
id: lnpChecker
title: Checking number portability
...
A number or set of numbers can be checked to see if they can be ported into the Bandwidth Network using the [`/accounts/{accountId}/lnpChecker`](/apis/numbers#operation/RequestPortabilityInfo) API endpoint.
