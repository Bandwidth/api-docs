...
A number or set of numbers can be checked to see if they can be ported into the Bandwidth Network. TNs can be ported in a single `/portins` request if all the following are true:
