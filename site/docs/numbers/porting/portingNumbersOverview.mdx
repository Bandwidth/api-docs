---
id: portingNumbersOverview
title: Bandwidth Porting Overview
slug: /api-docs/site/docs/numbers/porting/portingNumbersOverview.mdx
description: An overview of all of things related to porting at Bandwidth.
keywords:
  - Porting
  - Port-in
  - Port-out
...
For more detailed information about porting numbers in, please see [Port-ins Overview](/docs/numbers/guides/porting/portInOverview.mdx).
...
For detailed information about port-out requests (called LSRs) and port-out notifications, please refer to [Port-outs Overview](/docs/numbers/guides/porting/portOutOverview.mdx).
...
For more information about Orders, please refer to [Order Model](/docs/numbers/guides/porting/orderModel.mdx).
...
For detailed information about how to subscribe for order notifications, please see [Subscribe/Notify](/tbd).


# Porting Terminology

For a table of porting terms, please refer to [Porting Terminology](/docs/numbers/guides/porting/terminology.mdx).
