...
slug: /api-docs/site/docs/numbers/porting/portOutNotifications.mdx
description: An overview of Bandwidth port-out notifications.
keywords:
  - Porting
  - Port-out
  - LSR
...
<strong>Code</strong>
  ...
  <tr>
   ...
   <td>Request placed in Exception
   </td>
  </tr>
  <tr>
   <td>7511
  ...
  <tr>
   ...
   <td>Fatal Error in Processing
   </td>
   <td><strong>Request succeeds</strong>
   </td>
  </tr>
  <tr>
   <td>nnnn
...
For details on how to subscribe to port-out notifications, please refer to the [Order Webhook Guide](/docs/numbers/webhooks/orderWebhook), and the [/accounts/{accountId}/subscriptions](/apis/numbers/#operation/CreateSubscriptions) API.
