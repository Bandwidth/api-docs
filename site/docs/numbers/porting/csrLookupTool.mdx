...
Before creating the order, be sure to collect any information from the end user to submit to the [/csrs API](/apis/numbers/#operation/CreateCsrOrder). Generally speaking, the more information provided, the better.
