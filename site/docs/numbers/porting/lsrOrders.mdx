...
In summary the LSR request includes:
...
To update lsr order, you must make a <Highlight color="#9a59c5">PUT</Highlight> request to our [/lsrorders/{orderId} API](/apis/numbers/#operation/UpdateLsrOrder) endpoint. This can be done using tools like Postman or cURL.
