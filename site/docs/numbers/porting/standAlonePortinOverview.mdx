---
id: standAlonePortinOverview
title: Stand-Alone Port-in Overview
slug: /api-docs/site/docs/numbers/porting/standAlonePortinOverview.mdx
description: An overview of stand-alone port-ins
keywords:
  - Porting
  - Port-in
  - Stand-Alone Port-in
...
* [Checking Portability for Regular Numbers](/docs/numbers/guides/porting/lnpChecker.mdx)
* [Checking Portability for Toll Free Numbers](/docs/numbers/guides/porting/tollFreePortingValidations.mdx)
...
The /lnpchecker tool is described in [LNP Checker](/docs/numbers/guides/porting/lnpChecker.mdx).

The /tollFreePortingValidations tool is described in [Toll Free Porting Validations](/docs/numbers/guides/porting/tollFreePortingValidations.mdx).
...
<table>
  <tr>
   ...
   <td><strong>Content Header</strong>
   </td>
  </tr>
  <tr>
   <td>CSV
