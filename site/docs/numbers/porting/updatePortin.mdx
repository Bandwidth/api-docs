...
In this guide we will show you how to manage your Port in order. We assume that you have [created Port in order](/docs/numbers/guides/porting/updatePortin).
...
### Examples
To update Port-in request, you must make a <Highlight color="#9a59c5">PUT</Highlight> request to our [API /portins/{orderId}](/apis/numbers/#operation/UpdatePortin) endpoint. This can be done using tools like Postman, or in command line.
