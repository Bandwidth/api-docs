...
In the above scenario, all telephone numbers will be accounted for in the PortableTnList or an Error element. For details on toll free number validation, please see [Toll Free Porting Validations](/docs/numbers/porting/port-ins/stand-alone-port-ins/tollFreePortingValidations).
