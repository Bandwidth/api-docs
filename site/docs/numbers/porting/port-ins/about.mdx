...
1. Determine if the telephone numbers are portable [LNP Checker](/docs/numbers/guides/porting/lnpChecker) for regular numbers [Toll Free Porting Validations](/docs/numbers/guides/porting/tollFreePortingValidations) for toll free numbers.
2. Create a port-in request [Stand Alone Port-ins Overview](/docs/numbers/guides/porting/standAlonePortinsOverview), [Bulk Port-ins](/docs/numbers/guides/porting/bulkPortins).
3. Upload necessary documents &lt;</loas HL>>
4. Submit the port-in request (see Draft Port-ins section below)
5. Receive FOC Stand Alone Port-ins: Fetching Port-in Status [Subscriptions](/apis/numbers/#operation/CreateSubscriptions)
