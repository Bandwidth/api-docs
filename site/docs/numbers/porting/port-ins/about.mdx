...
1. Determine if the telephone numbers are portable [LNP Checker](/docs/numbers/porting/port-ins/stand-alone-port-ins/lnpChecker) for regular numbers [Toll Free Porting Validations](/docs/numbers/porting/port-ins/stand-alone-port-ins/tollFreePortingValidations) for toll free numbers.
...
For a stand-alone port-in, the API user is responsible for determining which TNs can be ported together. Bandwidth supplies tools to assist with this function that differ between regular numbers and toll free numbers. (See [Checking Portability for Regular Numbers](/docs/numbers/porting/port-ins/stand-alone-port-ins/lnpChecker) and [Checking Portability for Toll Free Numbers](/docs/numbers/porting/port-ins/stand-alone-port-ins/tollFreePortingValidations). For more detailed information on stand-alone port-ins, please refer to [Stand-Alone Port-ins](/docs/numbers/porting/port-ins/stand-alone-port-ins).
...
Or, for more general information: [LNP Checker](/docs/numbers/porting/port-ins/stand-alone-port-ins/lnpChecker)
...
Or, for more general information: [Toll Free Porting Validations](/docs/numbers/porting/port-ins/stand-alone-port-ins/tollFreePortingValidations)
