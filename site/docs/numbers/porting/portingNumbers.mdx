...
To poll an information about your Port in you can still use a <Highlight color="#00bf8c">GET</Highlight> request to [/portins API](/apis/numbers/#operation/GetPortin). This can be done through our [SDKs](/sdks), using tools like [Postman](https://github.com/Bandwidth/postman), or in command line.
