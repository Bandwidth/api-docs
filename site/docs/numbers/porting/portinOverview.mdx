---
id: portinOverview
title: Port-in Overview
slug: /api-docs/site/docs/numbers/porting/portinOverview.mdx
description: An overview of porting numbers into Bandwidth.
keywords:
  - Porting
  - Port-in
  - Bulk Port-in
...
1. Determine if the telephone numbers are portable [LNP Checker](/docs/numbers/guides/porting/lnpChecker.mdx) for regular numbers [Toll Free Porting Validations](/docs/numbers/guides/porting/tollFreePortingValidations.mdx) for toll free numbers.
2. Create a port-in request [Stand Alone Port-ins Overview](/docs/numbers/guides/porting/standAlonePortinsOverview.mdx), [Bulk Port-ins](/docs/numbers/guides/porting/bulkPortins.mdx).
3. Upload necessary documents &lt;</loas HL>>
4. Submit the port-in request (see Draft Port-ins section below)
5. Receive FOC &lt;<Stand Alone Port-ins: Fetching Port-in Status HL>> [Subscriptions](/apis/numbers/#operation/CreateSubscriptions)
6. Activate the port-in on FOC day &lt;<Stand Alone Port-ins: Port-in Activation HL>>
...
For a stand-alone port-in, the API user is responsible for determining which TNs can be ported together.  Bandwidth supplies tools to assist with this function that differ between regular numbers and toll free numbers.  (See [Checking Portability for Regular Numbers](/apis/numbers/#operation/CreateSubscriptions) and [Checking Portability for Toll Free Numbers](/docs/numbers/guides/porting/tollFreePortingValidations.mdx)).  For more detailed information on stand-alone port-ins, please refer to [Stand-Alone Port-ins](/docs/numbers/guides/porting/standAlonePortinsOverview.mdx).
...
[LNP Checker](/docs/numbers/guides/porting/lnpChecker.mdx)
...
[Toll Free Porting Validations](/docs/numbers/guides/porting/tollFreePortingValidations.mdx)
...
For more information on bulk port-ins, please refer to [Bulk Port-ins](/docs/numbers/guides/porting/bulkPortins.mdx).
