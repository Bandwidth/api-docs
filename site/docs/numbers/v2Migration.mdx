...
description: Iris API v2 Migration Guide
slug: /numbers/v2Migration
sidebar_label: Iris API v2 Migration
hide_title: false
...
### Introduction
V2 of the Iris API introduces several changes that make it possible for Iris to handle international numbers with country codes. This is done via the introduction of e164 format as the standard across the API.
...
In order to integrate with V2 of the Iris API, you will need to make several changes to match this new format.
- Update endpoint calls to use ‘v2’ instead of ‘v1’ in the routes
- Update your callback subscriptions to be e164 compliant
- Update your Jasper Report requests to use the v2 routes
- Update all of your code that involves Telephone Numbers to send numbers in e164 format, as well as to expect Iris to return e164 format to you.

### Updates from v1
Search endpoint now takes new parameters
<Tabs groupId="iris_v2_api_migration" defaultValue="v2" values={[ { label: 'v1', value: 'v1', }, { label: 'v2', value: 'v2', } ]}>
  <TabItem value="v1">
