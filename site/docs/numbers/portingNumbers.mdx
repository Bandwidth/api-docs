...
The Bandwidth Phone Number API can be used to submit Port-In requests. These requests move phone numbers from a "losing carrier" to Bandwidth are part of the Local Number Portability (LNP) process. These LNP requests are automatically validated and processed.
