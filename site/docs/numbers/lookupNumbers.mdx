...
## Fetch Requests Information

Since the TN Lookup request processing is asynchronous,  make a <Highlight color="#00bf8c">GET</Highlight> request
to our [Get Lookup Order Status API](../../../../apis/number-lookup#tag/Phone-Number-Lookup/operation/getLookupStatus) endpoint to determine the status.
