...
If there are invalid, or non-portable telephone numbers, a GET on [/tnList](https://dev.bandwidth.com/apis/numbers/#operation/ListBulkTns) /tnList will show the errors. If all
