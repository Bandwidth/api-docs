...
To generate a specific report, you must make a <Highlight color="#079CEE">POST</Highlight> request to our [Create Report Instance API](/apis/numbers/#tag/Reports/operation/CreateReportInstance/) endpoint.
