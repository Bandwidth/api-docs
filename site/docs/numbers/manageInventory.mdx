...
In this guide, we will show you how to manage inventory across your Bandwidth account using the number search, detail, and reservation APIs. Associating the number with “Option” or “Feature” characteristics.
...
To show number sites, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Sites API](../../../../apis/numbers#tag/accounts/operation/RetrieveSiteForThatTn) endpoint.
...
To show number sip-peers, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Sip-Peers API](../../../../apis/numbers#tag/accounts/operation/RetrieveSippeerForThatTn) endpoint.
...
There are a set of TN capabilities that can be assigned directly to the Telephone Number on a per-TN basis.

To retrieve or update these options, make a request to our [Update SipPeer TNs settings API](../../../../apis/numbers#tag/accounts/operation/UpdateSipPeerTnSettings) endpoint.
...
Use one of the example to update **Call Forwarding** option for Telephone Number
...
Use one of the example to update **Rewrite User** option for Telephone Number
...
Use one of the example to update **Inbound Calls Number Format** option for Telephone Number.
...
Use one of the example to update **Remote Party ID Format** option for Telephone Number.
...
values={[
    ...
    { label: 'Directory Listing and Directory Assistance (DLDA Order)', value: 'dlda', }
]
}>
...
To create a DLDA Order, make a <Highlight color="#079CEE">POST</Highlight> request to our [Create DLDA Order API](../../../../apis/numbers#tag/accounts/operation/CreateDldaOrder) endpoint.
This can be done through tools like [Postman](https://github.com/Bandwidth/postman) or in the command line.
...
Since the DLDA order is asynchronous, it is recommended to create a dldas subscription to receive order status webhooks.
Otherwise, you can make <Highlight color="#00bf8c">GET</Highlight> request to [Fetch DLDA Order status API](../../../../apis/numbers#tag/accounts/operation/ReadDldaOrder) endpoint to poll the order status.
