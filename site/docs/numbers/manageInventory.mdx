...
Bandwidth offers an API that allows you to manage your inventory and show detailed information about telephone numbers on any of your account.

In this guide we will show you how to search telephone numbers across your accounts with their detailed information if needed.

## Search All Numbers

To search telephone numbers and view possible search parameters, make a <Highlight color="#00bf8c">GET</Highlight> request to our [List Numbers API](../../../../apis/numbers#tag/tns/operation/ListTnsByGet) endpoint.
...
To search for specific telephone numbers, make a <Highlight color="#079CEE">POST</Highlight> request to our [List Numbers API](../../../../apis/numbers#tag/tns/operation/ListTnsByPost) endpoint.
This can be done through tools like [Postman](https://github.com/Bandwidth/postman) or in the command line.
...
To show general number information, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Information API](../../../../apis/numbers#tag/tns/operation/ListTnsByGet) endpoint.
...
To show number details, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Details API](../../../../apis/numbers#tag/tns/operation/RetrieveTnDetails) endpoint.
...
To show number sites, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Sites API](../../../../apis/numbers#tag/tns/operation/RetrieveSiteForThatTn) endpoint.
...
To show number sip-peers, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Sip-Peers API](../../../../apis/numbers#tag/tns/operation/RetrieveSippeerForThatTn) endpoint.
...
To show number rate center, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Rate Center API](../../../../apis/numbers#tag/tns/operation/RetrieveRateCenterForThatTn) endpoint.
...
To show number LCA, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN LCA API](../../../../apis/numbers#tag/tns/operation/RetrieveLCAForThatTn) endpoint.
...
To show number LATA, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN LATA API](../../../../apis/numbers#tag/tns/operation/RetrieveLataForThatTn) endpoint.
...
To show number reservation, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN Reservation API](../../../../apis/numbers#tag/tns/operation/RetrieveTnReservetionInfoForThatTn) endpoint.
...
To show number available NNRoutes, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Retrieve TN NNRoutes API](../../../../apis/numbers#tag/tns/operation/RetrieveRouteForThatTn) endpoint.
