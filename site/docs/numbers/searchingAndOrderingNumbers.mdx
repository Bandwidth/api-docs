...
### Search Parameters
To search for an available number and view possible search parameters, make a <Highlight color="#00bf8c">GET</Highlight> request to our [Available Numbers API](/apis/numbers/#tag/Available-Tns/operation/GetAvailableTns/) endpoint.
...
The `orderType` parameter of the request schema in [Order Numbers API](/apis/numbers/#tag/Orders/operation/CreateOrder/)
...
To order numbers, you must make a <Highlight color="#079CEE">POST</Highlight> request to our [Order Numbers API](/apis/numbers/#tag/Orders/operation/CreateOrder/) endpoint.
This can be done through tools like [Postman](https://github.com/Bandwidth/postman) or cURL.
...
To poll for Order status you have to send <Highlight color="#00bf8c">GET</Highlight> request with order ID to our [Fetch Order Status API](/apis/numbers/#tag/Orders/operation/RetrieveOrder/) endpoint.
:::
...
- [How to port numbers](/docs/numbers/porting/port-ins/)
