    ...
    return (
        <Layout
          ...
          keywords="Bandwidth,API,MFA,2FA,Authentication">
            <ApiReference spec={siteConfig.customFields.multiFactorAuthSpec} color={siteConfig.customFields.mfaGreen} downloadDefinitionUrl={siteConfig.customFields.multiFactorAuthSpecLink}/>
        </Layout>
    );
}
