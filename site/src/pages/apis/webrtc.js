    ...
    return (
        <Layout
          ...
          keywords="Bandwidth,API,WebRtc">
            <ApiReference spec={siteConfig.customFields.webRTCSpec} color={siteConfig.customFields.webRtcBlue} downloadDefinitionUrl={siteConfig.customFields.webRtcSpecLink}/>
        </Layout>
    );
}
