        ...
        <div className={styles.sdkProductTable}>
          ...
          <tbody>
            <tr>
              ...
              <td><a href="https://github.com/Bandwidth/ruby-sdk"></a></td>
            </tr>
            <tr>
              ...
              <td><a href="https://github.com/Bandwidth/ruby-bandwidth-iris"></a></td>
            </tr>
            <tr>
              <td>Code Samples</td>
              <td>Code Samples showing how to utilize the Bandwidth Ruby SDK</td>
              <td><a href="https://github.com/orgs/Bandwidth-Samples/repositories?language=ruby"></a></td>
            </tr>
          </tbody>
          </table>
        </div>
