        ...
        <div className={styles.sdkProductTable}>
          ...
          <tbody>
            <tr>
              ...
              <td><a href="https://github.com/Bandwidth/java-sdk"></a></td>
            </tr>
            <tr>
              ...
              <td><a href="https://github.com/Bandwidth/java-bandwidth-iris"></a></td>
            </tr>
            <tr>
              <td>Code Samples</td>
              <td>Code Samples showing how to utilize the Bandwidth Java SDK</td>
              <td><a href="https://github.com/orgs/Bandwidth-Samples/repositories?language=java"></a></td>
            </tr>
          </tbody>
          </table>
        </div>
